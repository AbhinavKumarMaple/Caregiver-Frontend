...
import ScheduleCardSkeleton from "../../features/schedule/components/ScheduleCardSkeleton";
    ...
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-7 sm:mt-2">
        {[0, 1, 2].map((index) => (
          <div
            key={index}
            className={`p-4 rounded-2xl shadow-sm bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100  text-center ${
      ...
      <div className="w-full flex justify-between items-center mt-5">
        <div className="flex items-center">
          ...
          <Skeleton
            width={40}
            height={28}
            className="bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100  rounded-lg"
          />
        </div>
